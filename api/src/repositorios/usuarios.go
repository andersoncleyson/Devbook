...
// Atualizer altera as informações de um usuário no bando de dados
...
// Deletar exclui as informações de um usuário em um banco de dados
...
// PararDeSeguir faz um usuário parar de seguir outro usuario
...
// Buscar seguidores traz todos os seguidores de um usuário
...
// BuscarSeguindo tras todos os seguidos pelo usuário
func (repositorio Usuarios) BuscarSeguindo(usuarioID uint64) ([]modelos.Usuario, error){
	linhas, erro := repositorio.db.Query(`
		select u.id, u.nome, u.nick, u.email, u.criadoEm
		from usuarios u inner join seguidores s on u.id = s.seguidor_id where s.seguidor_id = ?
	`, usuarioID)
